...
<li><a rel="tooltip" href="?class=database_mysql&method=connect_long" title="This pulls the credentials you used when logging into the database. This is the long version. Most useful if you need to grab the credentials later in the script.">Connect<i class="icon-caret-right"></i></a></li>
</ul>
</li>
<li>
...
<li><a rel="tooltip" href="?class=database_mysql&method=insert_long" title="This runs all the variables [processed via POST] through the sql_val function and then into the database.<br />This is the &quot;long&quot; version.<br />See non [Alt] if you want a &quot;compact&quot; version.">Insert<i class="icon-caret-right"></i></a></li>
</ul>
</li>
<li>
...
<li><a rel="tooltip" href="?class=database_mysql&method=update_long" title="Using the first column from the table as an identifier, this will update the database row that is equal to the identifiers value.<br />This is a compact version.<br />See [Alt] if you want a &quot;long&quot; version.">Update<i class="icon-caret-right"></i></a></li>
</ul>
</li>
<li>
