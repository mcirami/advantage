...
function select_maker() {
	...
	$return .= '<br />$result = mysql_query($query) or die(\'&lt;p class="db_error">&lt;b>A fatal MySQL error occured&lt;/b>&lt;br />Query: \'.$query.\'&lt;br />Error: (\'.mysql_errno().\') \'.mysql_error().\'&lt;/p>\');';
	$return .= '<br />while ($row = mysql_fetch_assoc($result)) { ';
...
function find_dups() {
	...
	$return .= '$result = mysql_query($query);<br />';
	$return .= '$num    = mysql_numrows($result);<br />';
...
function auto_incre_safe() {
	...
	$return .= '$result = mysql_query($query) or die(\'&lt;p class="db_error">&lt;b>A fatal MySQL error occurred while trying to save &lt;b>\'.reverb($'.$this->first_fields.').\'&lt;/b> to the database.&lt;/b>&lt;br />Query: \'.$query.\'&lt;br />Error: (\'.mysql_errno().\') \'.mysql_error().\'&lt;/p>\');<br />';
	...
	$return .= '$result = mysql_query($query) or die(\'&lt;p class="db_error">&lt;b>A fatal MySQL error occurred while trying to update &lt;b>\'.reverb($' . $this->first_fields . ').\'&lt;/b> in the database.&lt;/b>&lt;br />Query: \'.$query.\'&lt;br />Error: (\'.mysql_errno().\') \'.mysql_error().\'&lt;/p>\');<br />';
...
function auto_incre() {
		...
		$return .= '$rai = mysql_query($qai) or die(\'&lt;p class="db_error">A fatal MySQL error occurred &lt;br />Query: \'.$qai.\'&lt;br />Error: (\'.mysql_errno().\') \'.mysql_error().\'&lt;/p>\');<br />';
		$return .= '$row = mysql_fetch_assoc($rai);<br />';
...
function auto_incre_alt() {
		$return="";
		$return .= '$nai = mysql_fetch_assoc(mysql_query("SHOW TABLE STATUS LIKE \''.$this->myTable.'\'")) or die(\'&lt;p class="db_error">A fatal MySQL error occurred &lt;br />Error: (\'.mysql_errno().\') \'.mysql_error().\'&lt;/p>\');<br />';
...
function pagination() {
		...
		$return .= '[tab]$max_rows = current(mysql_fetch_row(mysql_query(\'SELECT COUNT(1) FROM ' . $this->myTable . ' WHERE `' . $this->first_fields . '` LIKE \'.sql_val(\'<span class="bx cz">%</span>\'.$'.$this->pgr.'[\'' . $this->first_fields . '\'].\'<span class="bx cz">%</span>\'))));<br />';
