...
class database_mysql extends DBCG {
	...
	$this->show_compact_button = 1;
		$return  = '$dbconnect = mysqli_connect(\'' . $this->myServer . '\', \'' . $this->myUser . '\', \'' . $this->myPass . '\', \'' . $this->myDB . '\');<br />';
		$return .= 'if (mysqli_connect_errno()) { echo "Failed to connect to MySQL: " . mysqli_connect_error(); }';
	...
	function connect_long() {
		...
		$return .= '$dbconnect = mysqli_connect($myServer, $myUser, $myPass, $myDB);<br />';
		$return .= 'if (mysqli_connect_errno()) { echo "Failed to connect to MySQL: " . mysqli_connect_error(); }<br />';
		return $this->tabulate($return);
	}
...
$this->show_query_form = 1;
	...
	function select_count() {
		...
		$return .= $this->db_result();
		$return .= '$row = mysqli_fetch_row($result);<br />';
		$return .= 'echo $row[0];';
		return $this->tabulate($return);
	}
